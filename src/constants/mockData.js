export const APP_LIST = [
  { appName: 'AppCoreHub', description: '底座应用', version: '1.0.0', buildTime: '2024-01-10 09:00' },
  { appName: 'AppCustomer', description: '客户管理子应用', version: '3.2.0', buildTime: '2024-01-20 10:00' },
  { appName: 'AppMall', description: '商城子应用', version: '4.4.5', buildTime: '2024-01-19 15:30' },
  { appName: 'AppSpace', description: '空间管理子应用', version: '2.0.1', buildTime: '2024-01-21 09:15' },
  { appName: 'AppMember', description: '会员中心子应用', version: '4.0.9', buildTime: '2024-01-18 14:20' },
  { appName: 'AppPatrolManagement', description: '巡更管理子应用', version: '4.3.2', buildTime: '2024-01-22 11:45' },
  { appName: 'AppInvestment', description: '招商管理子应用', version: '4.0.0', buildTime: '2024-01-15 16:00' }
];

export const CAPABILITIES = [
  { key: 'customer.list', name: '客户列表', desc: '查询和管理客户信息', source: 'AppCustomer', type: 'Page', versions: '4.2.0,4.2.2,4.4.0', status: 'normal' },
  { key: 'customer.detail', name: '客户详情', desc: '查看客户详细资料', source: 'AppCustomer', type: 'Page', versions: '4.2.0', status: 'normal' },
  { key: 'customer.create', name: '新建客户', desc: '创建新客户', source: 'AppCustomer', type: 'Button', versions: '4.2.0,4.2.2,4.4.0', status: 'normal' },

  { key: 'mall.product.list', name: '商品列表', desc: '管理商城商品', source: 'AppMall', type: 'Page', versions: '4.4.5', status: 'normal' },
  { key: 'mall.order.list', name: '订单列表', desc: '查看所有订单', source: 'AppMall', type: 'Page', versions: '4.4.5', status: 'changed' },
  { key: 'mall.order.detail', name: '订单详情', desc: '查看订单详情', source: 'AppMall', type: 'Page', versions: '4.4.5', status: 'normal' },

  { key: 'space.room.list', name: '房间列表', desc: '空间资源列表', source: 'AppSpace', type: 'Page', versions: '2.0.1', status: 'normal' },
  { key: 'space.booking', name: '空间预订', desc: '预订会议室或工位', source: 'AppSpace', type: 'Page', versions: '2.0.1', status: 'new' },

  { key: 'member.profile', name: '会员档案', desc: '会员基础信息', source: 'AppMember', type: 'Page', versions: '4.0.9', status: 'deprecated' },
  { key: 'member.points', name: '积分管理', desc: '会员积分流水', source: 'AppMember', type: 'Page', versions: '4.0.9', status: 'normal' }
];

export const VERSIONS = [
  { value: 'v4.2.0', label: 'v4.2.0 (Current)' },
  { value: 'v4.4.0', label: 'v4.4.0 (2024-01-10)' },
  { value: 'v4.0.0', label: 'v4.0.0 (2023-12-25)' },
  { value: 'v2.0.0-beta', label: 'v2.0.0-beta (Preview)' }
];

export const DEPENDENCY_MAP = {
  AppCustomer: [
    { id: 'AppCoreHub', category: 'frontend', type: 'Micro App', mode: 'Remote', status: 'Running', desc: '底座应用', version: '1.0.0' },
  ...
  AppMall: [
    ...
    { id: 'AppMember', category: 'frontend', type: 'Micro App', mode: 'Remote', status: 'Ready', desc: '会员信息依赖', version: '4.0.9' }
  ],
  AppSpace: [
    { id: 'AppCoreHub', category: 'frontend', type: 'Micro App', mode: 'Remote', status: 'Running', desc: '底座应用', version: '1.0.0' },
