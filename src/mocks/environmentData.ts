...
export const APP_OPTIONS: IAppOption[] = [
    ...
    { label: "商城 (AppMall)", value: "AppMall" },
    { label: "票务 (AppCommerce)", value: "AppCommerce" },
    { label: "客户中心 (AppCustomer)", value: "AppCustomer" },
    { label: "会员中心 (AppMember)", value: "AppMember" },
    { label: "空间管理 (AppSpace)", value: "AppSpace" },
    { label: "魔方应用 (AppCube)", value: "AppCube" },
    { label: "审批应用 (AppApprove)", value: "AppApprove" },
    { label: "能源管理 (AppEnergy)", value: "AppEnergy" },
    { label: "会议室 (AppMeeting)", value: "AppMeeting" },
    { label: "运营管理 (AppOperation)", value: "AppOperation" },
    { label: "停车管理 (AppParking)", value: "AppParking" },
];
...
export const CONFIG_VERSIONS: IConfigVersion[] = [
    {
        id: "cfg-4.4.0",
        name: "4.4.0-产品化",
        description: "4.4.0 产品化主配置（大部分应用跟随 4.4.0）",
        createdAt: "2026-01-05 10:00:00",
        updatedAt: "2026-02-01 10:00:00",
        dependencies: [
            { appId: "AppAi", version: "4.4.0" },
            { appId: "AppMall", version: "4.4.0" },
            { appId: "AppCommerce", version: "4.4.0" },
            { appId: "AppCustomer", version: "4.4.0" },
            { appId: "AppMember", version: "4.3.4" },
            { appId: "AppSpace", version: "4.3.4" },
            { appId: "AppCube", version: "4.4.0" },
            { appId: "AppApprove", version: "4.3.4" },
            { appId: "AppEnergy", version: "4.4.0" },
            { appId: "AppMeeting", version: "4.4.0" },
            { appId: "AppOperation", version: "4.4.0" },
            { appId: "AppParking", version: "4.3.4" },
        ],
    },
    {
        id: "cfg-4.3.4",
        name: "4.3.4-产品化",
        description: "4.3.4 产品化主配置（大部分应用跟随 4.3.4）",
        ...
        dependencies: [
            ...
            { appId: "AppCustomer", version: "4.3.4" },
            { appId: "AppMember", version: "4.3.4" },
            { appId: "AppSpace", version: "4.3.0" },
            { appId: "AppCube", version: "4.3.4" },
            { appId: "AppApprove", version: "4.3.4" },
            { appId: "AppEnergy", version: "4.3.4" },
            { appId: "AppMeeting", version: "4.3.4" },
            { appId: "AppOperation", version: "4.3.0" },
            { appId: "AppParking", version: "4.2.4" },
        ],
    },
    {
        id: "cfg-4.2.0",
        name: "4.2.0-产品化",
        description: "4.2.0 产品化主配置（大部分应用跟随 4.2.0）",
        createdAt: "2026-01-12 09:00:00",
        updatedAt: "2026-02-03 14:10:00",
        dependencies: [
            { appId: "AppAi", version: "4.2.0" },
            { appId: "AppMall", version: "4.2.0" },
            { appId: "AppCommerce", version: "4.2.0" },
            { appId: "AppCustomer", version: "4.2.0" },
            { appId: "AppMember", version: "4.2.0" },
            { appId: "AppSpace", version: "4.2.4" },
            { appId: "AppCube", version: "4.2.4" },
            { appId: "AppApprove", version: "4.1.0" },
            { appId: "AppEnergy", version: "4.2.0" },
            { appId: "AppMeeting", version: "4.2.0" },
            { appId: "AppOperation", version: "4.2.4" },
            { appId: "AppParking", version: "4.2.0" },
        ],
    },
    {
        id: "cfg-4.2.2-dsh",
        name: "4.2.2-独墅湖",
        description: "独墅湖定制配置表：大部分 4.2.2，个别 4.2.2-dsh",
        createdAt: "2026-01-18 11:00:00",
        updatedAt: "2026-02-04 09:10:00",
        dependencies: [
            { appId: "AppAi", version: "4.2.2" },
            { appId: "AppMall", version: "4.2.2" },
            { appId: "AppCommerce", version: "4.2.2" },
            { appId: "AppCustomer", version: "4.2.2" },
            { appId: "AppMember", version: "4.2.2" },
            { appId: "AppSpace", version: "4.2.2-dsh" },
            { appId: "AppCube", version: "4.2.2" },
            { appId: "AppApprove", version: "4.2.2-dsh" },
            { appId: "AppEnergy", version: "4.2.2" },
            { appId: "AppMeeting", version: "4.2.2" },
            { appId: "AppOperation", version: "4.2.2" },
            { appId: "AppParking", version: "4.2.2" },
        ],
    },
];
