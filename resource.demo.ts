import type { IResourcesDefinition } from "./src/types/resources";

export const resources: IResourcesDefinition = {
    app: {
        appId: "app-ai",
        appName: "AI 知识库",
    ...
    pages: [
        {
            ...
            actions: [
                { actionKey: "ai.knowledgeGraph.create" },
                { actionKey: "ai.knowledgeGraph.export" },
            ],
        },
        {
            ...
            actions: [
                { actionKey: "ai.knowledgeLibrary.import" },
                { actionKey: "ai.knowledgeLibrary.sync" },
            ],
        },
        {
            ...
            actions: [
                { actionKey: "ai.questionLibrary.import" },
                { actionKey: "ai.questionLibrary.sync" },
            ],
        },
    ],
    dependencies: {
        frontendApps: [{ appId: "core-hub", versionRange: "^3.7.2" }],
        backendServices: [{ serviceId: "ai-service", versionRange: "^4.1.0" }],
    },
};
